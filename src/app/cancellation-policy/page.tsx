...
export const metadata: Metadata = {
  title: `Cancellation Policy | ${COMPANY_INFO.brandName}`,
  description: `Read the cancellation policy for ${COMPANY_INFO.brandName} at-home pet grooming services.`,
  alternates: {
    canonical: absoluteUrl("/cancellation-policy"),
  },
  openGraph: {
    title: `Cancellation Policy | ${COMPANY_INFO.brandName}`,
    description: `Read the cancellation policy for ${COMPANY_INFO.brandName}.`,
    ...
    <>
      <main className="min-h-[60vh] w-full flex flex-col items-center justify-center py-16 px-4">
        ...
        <div className="max-w-2xl w-full text-[#1b1582] font-fractul text-base md:text-lg leading-relaxed bg-white/80 rounded-xl shadow p-6">
          ...
          <p className="mb-4">At {COMPANY_INFO.brandName}, we value your time and strive to provide reliable service. Please review our Cancellation Policy below.</p>
